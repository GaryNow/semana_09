...
public class Propuesto_09_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnAdicionar(ActionEvent arg0) {
		...
		Factura factura = new Factura(ruc, empresa, unidades, precio);
	...
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		 ...
		 */
		txtS.setText("");
		imprimir("Cantidad de empresas\t\t: " + af.tamanio());
		imprimir("Suma de importes\t\t: " + af.sumaImportes());
		imprimir("Promedio de importes\t\t: " + af.promedio());
		imprimir("Importe Menor\t\t\t: " + af.importeMenor());
		imprimir("Importe Mayor\t\t\t: " + af.importeMayor());
		imprimir("Primer importe menor al promedio: " + af.primeraMenorAlPromedio());
