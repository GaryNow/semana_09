...
public class Problema_09_1 extends JFrame implements ActionListener {
	...
	protected void actionPerformedBtnReportar(ActionEvent arg0) {
		...
		imprimir("Nombre del primer desaprobado :  " + aa.primerDesaprobado());
		imprimir("Nombre del ultimo aprobado:  " + aa.ultimoAprobado());
		imprimir("Nombre del segundo desaprobado :  " + aa.segundoDesaprobado());
		imprimir("Nombre del penultimo aprobado :  " + aa.penultimoAprobado());
  	}
